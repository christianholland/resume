...
packages_used <- tibble::tribble(
  ...
  "Bioconductor package", Sys.Date(), "dorothea", "Available since Bioc 3.11", c("Tool to infer transcripion factor activities from gene expression data (Lead developer)"),
  "Bioconductor package", Sys.Date(), "progeny", "Available since Bioc 3.6", "Tool to infer pathway activities from gene expression data (contributor)."
)
packages_used %>%
